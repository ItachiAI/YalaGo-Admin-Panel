                                                                             ...
                                                                             <tr>
                                                                                    ...
                                                                                    <td>
                                                                                           <input type="checkbox"
                                                                                                  ...
                                                                                                  name="roles[]"
                                                                                                  class="permission"
                                                                                                  {{in_array('roles.list',$permissions)
                                                                                                  ? "checked" : "" }}
                                                                                                  {{$roles->id == 1 ?
                                                                                           'disabled' : ''}}>
                                                                                           <label class=" control-label2"
                                                                                           ...
                                                                                           <input type="checkbox"
                                                                                                  ...
                                                                                                  name="roles[]"
                                                                                                  class="permission"
                                                                                                  {{in_array('roles.create',$permissions)
                                                                                                  ? "checked" : "" }}
                                                                                                  {{$roles->id == 1 ?
                                                                                           'disabled' : ''}}>
                                                                                           <label class=" control-label2"
                                                                                           ...
                                                                                           <input type="checkbox"
                                                                                                  ...
                                                                                                  name="roles[]"
                                                                                                  class="permission"
                                                                                                  {{in_array('roles.store',$permissions)
                                                                                                  ? "checked" : "" }}
                                                                                                  {{$roles->id == 1 ?
                                                                                           'disabled' : ''}}>
                                                                                           <label class=" control-label2"
                                                                                           ...
                                                                                           <input type="checkbox"
                                                                                                  ...
                                                                                                  name="roles[]"
                                                                                                  class="permission"
                                                                                                  {{in_array('roles.edit',$permissions)
                                                                                                  ? "checked" : "" }}
                                                                                                  {{$roles->id == 1 ?
                                                                                           'disabled' : ''}}>
                                                                                           <label class=" control-label2"
                                                                                           ...
                                                                                           <input type="checkbox"
                                                                                                  ...
                                                                                                  name="roles[]"
                                                                                                  class="permission"
                                                                                                  {{in_array('roles.update',$permissions)
                                                                                                  ? "checked" : "" }}
                                                                                                  {{$roles->id == 1 ?
                                                                                           'disabled' : ''}}>
                                                                                           <label class=" control-label2"
                                                                                           ...
                                                                                           <input type="checkbox"
                                                                                                  ...
                                                                                                  name="roles[]"
                                                                                                  class="permission"
                                                                                                  {{in_array('roles.delete',$permissions)
                                                                                                  ? "checked" : "" }}
                                                                                                  {{$roles->id == 1 ?
                                                                                           'disabled' : ''}}>
                                                                                           <label class=" control-label2"
                                                                             ...
                                                                             <tr>
                                                                                    ...
                                                                                    <td>
                                                                                           <input type="checkbox"
                                                                                                  ...
                                                                                                  name="admins[]"
                                                                                                  class="permission"
                                                                                                  {{in_array('admin.list',$permissions)
                                                                                                  ? "checked" : "" }}
                                                                                                  {{$roles->id == 1 ?
                                                                                           'disabled' : ''}}>
                                                                                           <label class=" control-label2"
                                                                                           ...
                                                                                           <input type="checkbox"
                                                                                                  ...
                                                                                                  name="admins[]"
                                                                                                  class="permission"
                                                                                                  {{in_array('admin.create',$permissions)
                                                                                                  ? "checked" : "" }}
                                                                                                  {{$roles->id == 1 ?
                                                                                           'disabled' : ''}}>
                                                                                           <label class=" control-label2"
                                                                                           ...
                                                                                           <input type="checkbox"
                                                                                                  ...
                                                                                                  name="admins[]"
                                                                                                  class="permission"
                                                                                                  {{in_array('admin.store',$permissions)
                                                                                                  ? "checked" : "" }}
                                                                                                  {{$roles->id == 1 ?
                                                                                           'disabled' : ''}}>
                                                                                           <label class=" control-label2"
                                                                                           ...
                                                                                           <input type="checkbox"
                                                                                                  ...
                                                                                                  name="admins[]"
                                                                                                  class="permission"
                                                                                                  {{in_array('admin.edit',$permissions)
                                                                                                  ? "checked" : "" }}
                                                                                                  {{$roles->id == 1 ?
                                                                                           'disabled' : ''}}>
                                                                                           <label class=" control-label2"
                                                                                           ...
                                                                                           <input type="checkbox"
                                                                                                  ...
                                                                                                  name="admins[]"
                                                                                                  class="permission"
                                                                                                  {{in_array('admin.update',$permissions)
                                                                                                  ? "checked" : "" }}
                                                                                                  {{$roles->id == 1 ?
                                                                                           'disabled' : ''}}>
                                                                                           <label class=" control-label2"
                                                                                           ...
                                                                                           <input type="checkbox"
                                                                                                  ...
                                                                                                  name="admins[]"
                                                                                                  class="permission"
                                                                                                  {{in_array('admin.delete',$permissions)
                                                                                                  ? "checked" : "" }}
                                                                                                  {{$roles->id == 1 ?
                                                                                           'disabled' : ''}}>
                                                                                           <label class=" control-label2"
                                                                             ...
                                                                             <tr>
                                                                                    ...
                                                                                    <td>
                                                                                           <input type="checkbox"
                                                                                                  ...
                                                                                                  name="users[]"
                                                                                                  class="permission"
                                                                                                  {{in_array('user.list',$permissions)
                                                                                                  ? "checked" : "" }}
                                                                                                  {{$roles->id == 1 ?
                                                                                           'disabled' : ''}}>
                                                                                           <label class=" control-label2"
                                                                                           ...
                                                                                           <input type="checkbox"
                                                                                                  ...
                                                                                                  name="users[]"
                                                                                                  class="permission"
                                                                                                  {{in_array('user.edit',$permissions)
                                                                                                  ? "checked" : "" }}
                                                                                                  {{$roles->id == 1 ?
                                                                                           'disabled' : ''}}>
                                                                                           <label class=" control-label2"
                                                                                           ...
                                                                                           <input type="checkbox"
                                                                                                  ...
                                                                                                  name="users[]"
                                                                                                  class="permission"
                                                                                                  {{in_array('user.view',$permissions)
                                                                                                  ? "checked" : "" }}
                                                                                                  {{$roles->id == 1 ?
                                                                                           'disabled' : ''}}>
                                                                                           <label class=" control-label2"
                                                                             ...
                                                                             <tr>
                                                                                    ...
                                                                                    <td>
                                                                                           <input type="checkbox"
                                                                                                  ...
                                                                                                  name="drivers[]"
                                                                                                  class="permission"
                                                                                                  {{in_array('driver.list',$permissions)
                                                                                                  ? "checked" : "" }}
                                                                                                  {{$roles->id == 1 ?
                                                                                           'disabled' : ''}}>
                                                                                           <label class=" control-label2"
                                                                                           ...
                                                                                           <input type="checkbox"
                                                                                                  ...
                                                                                                  name="drivers[]"
                                                                                                  class="permission"
                                                                                                  {{in_array('driver.edit',$permissions)
                                                                                                  ? "checked" : "" }}
                                                                                                  {{$roles->id == 1 ?
                                                                                           'disabled' : ''}}>
                                                                                           <label class=" control-label2"
                                                                                           ...
                                                                                           <input type="checkbox"
                                                                                                  ...
                                                                                                  name="drivers[]"
                                                                                                  class="permission"
                                                                                                  {{in_array('driver.view',$permissions)
                                                                                                  ? "checked" : "" }}
                                                                                                  {{$roles->id == 1 ?
                                                                                           'disabled' : ''}}>
                                                                                           <label class=" control-label2"
                                                                                           ...
                                                                                           <input type="checkbox"
                                                                                                  ...
                                                                                                  name="drivers[]"
                                                                                                  class="permission"
                                                                                                  {{in_array('driver.delete',$permissions)
                                                                                                  ? "checked" : "" }}
                                                                                                  {{$roles->id == 1 ?
                                                                                           'disabled' : ''}}>
                                                                                           <label class=" control-label2"
                                                                             ...
                                                                             <tr>
                                                                                    ...
                                                                                    <td>
                                                                                           <input type="checkbox"
                                                                                                  ...
                                                                                                  class="permission"
                                                                                                  {{in_array('approve.driver.list',$permissions)
                                                                                                  ? "checked" : "" }}
                                                                                                  {{$roles->id == 1 ?
                                                                                           'disabled' : ''}}>
                                                                                           <label class=" control-label2"
                                                ...
                                                <label class=" control-label2"
                                                       for="approve-drivers-view">{{trans('lang.view')}}</label>-->
                                                                                           <input type="checkbox"
                                                                                                  ...
                                                                                                  name="approve_drivers[]"
                                                                                                  class="permission"
                                                                                                  {{in_array('approve.driver.delete',$permissions)
                                                                                                  ? "checked" : "" }}
                                                                                                  {{$roles->id == 1 ?
                                                                                           'disabled' : ''}}>
                                                                                           <label class=" control-label2"
                                                                             ...
                                                                             <tr>
                                                                                    ...
                                                                                    <td>
                                                                                           <input type="checkbox"
                                                                                                  ...
                                                                                                  class="permission"
                                                                                                  {{in_array('pending.driver.list',$permissions)
                                                                                                  ? "checked" : "" }}
                                                                                                  {{$roles->id == 1 ?
                                                                                           'disabled' : ''}}>
                                                                                           <label class="control-label2"
                                                ...
                                                <label class="control-label2"
                                                       for="pending-drivers-view">{{trans('lang.view')}}</label>-->
                                                                                           ...
                                                                                           <input type="checkbox"
                                                                                                  ...
                                                                                                  name="pending_drivers[]"
                                                                                                  class="permission"
                                                                                                  {{in_array('pending.driver.delete',$permissions)
                                                                                                  ? "checked" : "" }}
                                                                                                  {{$roles->id == 1 ?
                                                                                           'disabled' : ''}}>
                                                                                           <label class=" control-label2"
                                                                             ...
                                                                             <tr>
                                                                                    ...
                                                                                    <td>
                                                                                           <input type="checkbox"
                                                                                                  ...
                                                                                                  name="documents[]"
                                                                                                  class="permission"
                                                                                                  {{in_array('document.list',$permissions)
                                                                                                  ? "checked" : "" }}
                                                                                                  {{$roles->id == 1 ?
                                                                                           'disabled' : ''}}>
                                                                                           <label class=" control-label2"
                                                                                           ...
                                                                                           <input type="checkbox"
                                                                                                  ...
                                                                                                  name="documents[]"
                                                                                                  class="permission"
                                                                                                  {{in_array('document.create',$permissions)
                                                                                                  ? "checked" : "" }}
                                                                                                  {{$roles->id == 1 ?
                                                                                           'disabled' : ''}}>
                                                                                           <label class=" control-label2"
                                                                                           ...
                                                                                           <input type="checkbox"
                                                                                                  ...
                                                                                                  name="documents[]"
                                                                                                  class="permission"
                                                                                                  {{in_array('document.edit',$permissions)
                                                                                                  ? "checked" : "" }}
                                                                                                  {{$roles->id == 1 ?
                                                                                           'disabled' : ''}}>
                                                                                           <label class=" control-label2"
                                                                                           ...
                                                                                           <input type="checkbox"
                                                                                                  ...
                                                                                                  name="documents[]"
                                                                                                  class="permission"
                                                                                                  {{in_array('document.delete',$permissions)
                                                                                                  ? "checked" : "" }}
                                                                                                  {{$roles->id == 1 ?
                                                                                           'disabled' : ''}}>
                                                                                           <label class=" control-label2"
                                                                             ...
                                                                             <tr>
                                                                                    ...
                                                                                    <td>
                                                                                           <input type="checkbox"
                                                                                                  ...
                                                                                                  class="permission"
                                                                                                  {{in_array('document.deleted',$permissions)
                                                                                                  ? "checked" : "" }}
                                                                                                  {{$roles->id == 1 ?
                                                                                           'disabled' : ''}}>
                                                                             ...
                                                                             <tr>
                                                                                    ...
                                                                                    <td>
                                                                                           <input type="checkbox"
                                                                                                  ...
                                                                                                  class="permission"
                                                                                                  {{in_array('driver.document.list',$permissions)
                                                                                                  ? "checked" : "" }}
                                                                                                  {{$roles->id == 1 ?
                                                                                           'disabled' : ''}}>
                                                                                           ...
                                                                                           <input type="checkbox"
                                                                                                  ...
                                                                                                  name="drivers-document[]"
                                                                                                  class="permission"
                                                                                                  {{in_array('driver.document.edit',$permissions)
                                                                                                  ? "checked" : "" }}
                                                                                                  {{$roles->id == 1 ?
                                                                                           'disabled' : ''}}>
                                                                             ...
                                                                             <tr>
                                                                                    ...
                                                                                    <td>
                                                                                           <input type="checkbox"
                                                                                                  ...
                                                                                                  name="reports[]"
                                                                                                  class="permission"
                                                                                                  {{in_array('user.report',$permissions)
                                                                                                  ? "checked" : "" }}
                                                                                                  {{$roles->id == 1 ?
                                                                                           'disabled' : ''}}>
                                                                                           <label class="control-label2"
                                                                                           ...
                                                                                           <input type="checkbox"
                                                                                                  ...
                                                                                                  name="reports[]"
                                                                                                  class="permission"
                                                                                                  {{in_array('driver.report',$permissions)
                                                                                                  ? "checked" : "" }}
                                                                                                  {{$roles->id == 1 ?
                                                                                           'disabled' : ''}}>
                                                                                           <label class="control-label2"
                                                                                           ...
                                                                                           <input type="checkbox"
                                                                                                  ...
                                                                                                  name="reports[]"
                                                                                                  class="permission"
                                                                                                  {{in_array('ride.report',$permissions)
                                                                                                  ? "checked" : "" }}
                                                                                                  {{$roles->id == 1 ?
                                                                                           'disabled' : ''}}>
                                                                                           <label class="control-label2"
                                                                                           ...
                                                                                           <input type="checkbox"
                                                                                                  ...
                                                                                                  name="reports[]"
                                                                                                  class="permission"
                                                                                                  {{in_array('intercity.report',$permissions)
                                                                                                  ? "checked" : "" }}
                                                                                                  {{$roles->id == 1 ?
                                                                                           'disabled' : ''}}>
                                                                                           <label class="control-label2"
                                                                                           ...
                                                                                           <input type="checkbox"
                                                                                                  ...
                                                                                                  name="reports[]"
                                                                                                  class="permission"
                                                                                                  {{in_array('transaction.report',$permissions)
                                                                                                  ? "checked" : "" }}
                                                                                                  {{$roles->id == 1 ?
                                                                                           'disabled' : ''}}>
                                                                                           <label class="control-label2"
                                                                             ...
                                                                             <tr>
                                                                                    ...
                                                                                    <td>
                                                                                           <input type="checkbox"
                                                                                                  ...
                                                                                                  name="service[]"
                                                                                                  class="permission"
                                                                                                  {{in_array('service.list',$permissions)
                                                                                                  ? "checked" : "" }}
                                                                                                  {{$roles->id == 1 ?
                                                                                           'disabled' : ''}}>
                                                                                           <label class=" control-label2"
                                                                                           ...
                                                                                           <input type="checkbox"
                                                                                                  ...
                                                                                                  name="service[]"
                                                                                                  class="permission"
                                                                                                  {{in_array('service.create',$permissions)
                                                                                                  ? "checked" : "" }}
                                                                                                  {{$roles->id == 1 ?
                                                                                           'disabled' : ''}}>
                                                                                           <label class=" control-label2"
                                                                                           ...
                                                                                           <input type="checkbox"
                                                                                                  ...
                                                                                                  name="service[]"
                                                                                                  class="permission"
                                                                                                  {{in_array('service.edit',$permissions)
                                                                                                  ? "checked" : "" }}
                                                                                                  {{$roles->id == 1 ?
                                                                                           'disabled' : ''}}>
                                                                                           <label class=" control-label2"
                                                                                           ...
                                                                                           <input type="checkbox"
                                                                                                  ...
                                                                                                  name="service[]"
                                                                                                  class="permission"
                                                                                                  {{in_array('service.delete',$permissions)
                                                                                                  ? "checked" : "" }}
                                                                                                  {{$roles->id == 1 ?
                                                                                           'disabled' : ''}}>
                                                                                           <label class=" control-label2"
                                                                             ...
                                                                             <tr>
                                                                                    ...
                                                                                    <td>
                                                                                           <input type="checkbox"
                                                                                                  ...
                                                                                                  name="ride_order[]"
                                                                                                  class="permission"
                                                                                                  {{in_array('order.list',$permissions)
                                                                                                  ? "checked" : "" }}
                                                                                                  {{$roles->id == 1 ?
                                                                                           'disabled' : ''}}>
                                                                                           <label class=" control-label2"
                                                                                           ...
                                                                                           <input type="checkbox"
                                                                                                  ...
                                                                                                  name="ride_order[]"
                                                                                                  class="permission"
                                                                                                  {{in_array('order.view',$permissions)
                                                                                                  ? "checked" : "" }}
                                                                                                  {{$roles->id == 1 ?
                                                                                           'disabled' : ''}}>
                                                                                           <label class=" control-label2"
                                                                                           ...
                                                                                           <input type="checkbox"
                                                                                                  ...
                                                                                                  name="ride_order[]"
                                                                                                  class="permission"
                                                                                                  {{in_array('order.delete',$permissions)
                                                                                                  ? "checked" : "" }}
                                                                                                  {{$roles->id == 1 ?
                                                                                           'disabled' : ''}}>
                                                                                           <label class=" control-label2"
                                                                             ...
                                                                             <tr>
                                                                                    ...
                                                                                    <td>
                                                                                           <input type="checkbox"
                                                                                                  ...
                                                                                                  class="permission"
                                                                                                  {{in_array('intercity.service.list',$permissions)
                                                                                                  ? "checked" : "" }}
                                                                                                  {{$roles->id == 1 ?
                                                                                           'disabled' : ''}}>
                                                                                           <label class=" control-label2"
                                                                                           ...
                                                                                           <input type="checkbox"
                                                                                                  ...
                                                                                                  name="intercity_service[]"
                                                                                                  class="permission"
                                                                                                  {{in_array('intercity.service.edit',$permissions)
                                                                                                  ? "checked" : "" }}
                                                                                                  {{$roles->id == 1 ?
                                                                                           'disabled' : ''}}>
                                                                                           <label class=" control-label2"
                                                                                           ...
                                                                                           <input type="checkbox"
                                                                                                  ...
                                                                                                  name="intercity_service[]"
                                                                                                  class="permission"
                                                                                                  {{in_array('intercity.service.delete',$permissions)
                                                                                                  ? "checked" : "" }}
                                                                                                  {{$roles->id == 1 ?
                                                                                           'disabled' : ''}}>
                                                                                           <label class=" control-label2"
                                                                                                  for="intercity-delete">{{trans('lang.delete')}}</label>
                                                                             ...
                                                                             <tr>
                                                                                    ...
                                                                                    <td>
                                                                                           <input type="checkbox"
                                                                                                  ...
                                                                                                  class="permission"
                                                                                                  {{in_array('intercity.order.list',$permissions)
                                                                                                  ? "checked" : "" }}
                                                                                                  {{$roles->id == 1 ?
                                                                                           'disabled' : ''}}>
                                                                                           <label class=" control-label2"
                                                                                           ...
                                                                                           <input type="checkbox"
                                                                                                  ...
                                                                                                  name="intercity_order[]"
                                                                                                  class="permission"
                                                                                                  {{in_array('intercity.order.view',$permissions)
                                                                                                  ? "checked" : "" }}
                                                                                                  {{$roles->id == 1 ?
                                                                                           'disabled' : ''}}>
                                                                                           <label class=" control-label2"
                                                                                           ...
                                                                                           <input type="checkbox"
                                                                                                  ...
                                                                                                  name="intercity_order[]"
                                                                                                  class="permission"
                                                                                                  {{in_array('intercity.order.delete',$permissions)
                                                                                                  ? "checked" : "" }}
                                                                                                  {{$roles->id == 1 ?
                                                                                           'disabled' : ''}}>
                                                                                           <label class=" control-label2"
                                                                             ...
                                                                             <tr>
                                                                                    ...
                                                                                    <td>
                                                                                           <input type="checkbox"
                                                                                                  ...
                                                                                                  name="freight[]"
                                                                                                  class="permission"
                                                                                                  {{in_array('freight.list',$permissions)
                                                                                                  ? "checked" : "" }}
                                                                                                  {{$roles->id == 1 ?
                                                                                           'disabled' : ''}}>
                                                                                           <label class=" control-label2"
                                                                                           ...
                                                                                           <input type="checkbox"
                                                                                                  ...
                                                                                                  name="freight[]"
                                                                                                  class="permission"
                                                                                                  {{in_array('freight.create',$permissions)
                                                                                                  ? "checked" : "" }}
                                                                                                  {{$roles->id == 1 ?
                                                                                           'disabled' : ''}}>
                                                                                           <label class=" control-label2"
                                                                                           ...
                                                                                           <input type="checkbox"
                                                                                                  ...
                                                                                                  name="freight[]"
                                                                                                  class="permission"
                                                                                                  {{in_array('freight.edit',$permissions)
                                                                                                  ? "checked" : "" }}
                                                                                                  {{$roles->id == 1 ?
                                                                                           'disabled' : ''}}>
                                                                                           <label class=" control-label2"
                                                                                           ...
                                                                                           <input type="checkbox"
                                                                                                  ...
                                                                                                  name="freight[]"
                                                                                                  class="permission"
                                                                                                  {{in_array('freight.delete',$permissions)
                                                                                                  ? "checked" : "" }}
                                                                                                  {{$roles->id == 1 ?
                                                                                           'disabled' : ''}}>
                                                                                           <label class=" control-label2"
                                                                             ...
                                                                             <tr>
                                                                                    <td>
                                                                                           <strong>{{trans('lang.moving_vehicles')}}</strong>
                                                                                    </td>
                                                                                    <td>
                                                                                           <input type="checkbox"
                                                                                                  id="moving-list"
                                                                                                  ...
                                                                                                  name="moving[]"
                                                                                                  class="permission"
                                                                                                  {{in_array('moving.list',$permissions)
                                                                                                  ? "checked" : "" }}
                                                                                                  {{$roles->id == 1 ?
                                                                                           'disabled' : ''}}>
                                                                                           <label class=" control-label2"
                                                                                                  for="moving-list">{{trans('lang.list')}}</label>
                                                                                           ...
                                                                                           <input type="checkbox"
                                                                                                  ...
                                                                                                  name="moving[]"
                                                                                                  class="permission"
                                                                                                  {{in_array('moving.create',$permissions)
                                                                                                  ? "checked" : "" }}
                                                                                                  {{$roles->id == 1 ?
                                                                                           'disabled' : ''}}>
                                                                                           <label class=" control-label2"
                                                                                                  for="moving-create">{{trans('lang.create')}}</label>
                                                                                           ...
                                                                                           <input type="checkbox"
                                                                                                  ...
                                                                                                  name="moving[]"
                                                                                                  class="permission"
                                                                                                  {{in_array('moving.edit',$permissions)
                                                                                                  ? "checked" : "" }}
                                                                                                  {{$roles->id == 1 ?
                                                                                           'disabled' : ''}}>
                                                                                           <label class=" control-label2"
                                                                                                  for="moving-edit">{{trans('lang.edit')}}</label>
                                                                                           ...
                                                                                           <input type="checkbox"
                                                                                                  ...
                                                                                                  name="moving[]"
                                                                                                  class="permission"
                                                                                                  {{in_array('moving.delete',$permissions)
                                                                                                  ? "checked" : "" }}
                                                                                                  {{$roles->id == 1 ?
                                                                                           'disabled' : ''}}>
                                                                                           <label class=" control-label2"
                                                                                                  for="moving-delete">{{trans('lang.delete')}}</label>
                                                                             ...
                                                                             <tr>
                                                                                    ...
                                                                                    <td>
                                                                                           <input type="checkbox"
                                                                                                  ...
                                                                                                  name="airports[]"
                                                                                                  class="permission"
                                                                                                  {{in_array('airports.list',$permissions)
                                                                                                  ? "checked" : "" }}
                                                                                                  {{$roles->id == 1 ?
                                                                                           'disabled' : ''}}>
                                                                                           <label class=" control-label2"
                                                                                           ...
                                                                                           <input type="checkbox"
                                                                                                  ...
                                                                                                  name="airports[]"
                                                                                                  class="permission"
                                                                                                  {{in_array('airports.create',$permissions)
                                                                                                  ? "checked" : "" }}
                                                                                                  {{$roles->id == 1 ?
                                                                                           'disabled' : ''}}>
                                                                                           <label class=" control-label2"
                                                                                           ...
                                                                                           <input type="checkbox"
                                                                                                  ...
                                                                                                  name="airports[]"
                                                                                                  class="permission"
                                                                                                  {{in_array('airports.edit',$permissions)
                                                                                                  ? "checked" : "" }}
                                                                                                  {{$roles->id == 1 ?
                                                                                           'disabled' : ''}}>
                                                                                           <label class=" control-label2"
                                                                                           ...
                                                                                           <input type="checkbox"
                                                                                                  ...
                                                                                                  name="airports[]"
                                                                                                  class="permission"
                                                                                                  {{in_array('airports.delete',$permissions)
                                                                                                  ? "checked" : "" }}
                                                                                                  {{$roles->id == 1 ?
                                                                                           'disabled' : ''}}>
                                                                                           <label class=" control-label2"
                                                                             ...
                                                                             <tr>
                                                                                    ...
                                                                                    <td>
                                                                                           <input type="checkbox"
                                                                                                  ...
                                                                                                  name="vehicle-type[]"
                                                                                                  class="permission"
                                                                                                  {{in_array('vehicle.type.list',$permissions)
                                                                                                  ? "checked" : "" }}
                                                                                                  {{$roles->id == 1 ?
                                                                                           'disabled' : ''}}>
                                                                                           <label class=" control-label2"
                                                                                           ...
                                                                                           <input type="checkbox"
                                                                                                  ...
                                                                                                  name="vehicle-type[]"
                                                                                                  class="permission"
                                                                                                  {{in_array('vehicle.type.create',$permissions)
                                                                                                  ? "checked" : "" }}
                                                                                                  {{$roles->id == 1 ?
                                                                                           'disabled' : ''}}>
                                                                                           <label class=" control-label2"
                                                                                           ...
                                                                                           <input type="checkbox"
                                                                                                  ...
                                                                                                  name="vehicle-type[]"
                                                                                                  class="permission"
                                                                                                  {{in_array('vehicle.type.edit',$permissions)
                                                                                                  ? "checked" : "" }}
                                                                                                  {{$roles->id == 1 ?
                                                                                           'disabled' : ''}}>
                                                                                           <label class=" control-label2"
                                                                                           ...
                                                                                           <input type="checkbox"
                                                                                                  ...
                                                                                                  name="vehicle-type[]"
                                                                                                  class="permission"
                                                                                                  {{in_array('vehicle.type.delete',$permissions)
                                                                                                  ? "checked" : "" }}
                                                                                                  {{$roles->id == 1 ?
                                                                                           'disabled' : ''}}>
                                                                                           <label class=" control-label2"
                                                                             ...
                                                                             <tr>
                                                                                    ...
                                                                                    <td>
                                                                                           <input type="checkbox"
                                                                                                  ...
                                                                                                  name="driver-rules[]"
                                                                                                  class="permission"
                                                                                                  {{in_array('rule.list',$permissions)
                                                                                                  ? "checked" : "" }}
                                                                                                  {{$roles->id == 1 ?
                                                                                           'disabled' : ''}}>
                                                                                           <label class=" control-label2"
                                                                                           ...
                                                                                           <input type="checkbox"
                                                                                                  ...
                                                                                                  name="driver-rules[]"
                                                                                                  class="permission"
                                                                                                  {{in_array('rule.create',$permissions)
                                                                                                  ? "checked" : "" }}
                                                                                                  {{$roles->id == 1 ?
                                                                                           'disabled' : ''}}>
                                                                                           <label class=" control-label2"
                                                                                           ...
                                                                                           <input type="checkbox"
                                                                                                  ...
                                                                                                  name="driver-rules[]"
                                                                                                  class="permission"
                                                                                                  {{in_array('rule.edit',$permissions)
                                                                                                  ? "checked" : "" }}
                                                                                                  {{$roles->id == 1 ?
                                                                                           'disabled' : ''}}>
                                                                                           <label class=" control-label2"
                                                                                           ...
                                                                                           <input type="checkbox"
                                                                                                  ...
                                                                                                  name="driver-rules[]"
                                                                                                  class="permission"
                                                                                                  {{in_array('rule.delete',$permissions)
                                                                                                  ? "checked" : "" }}
                                                                                                  {{$roles->id == 1 ?
                                                                                           'disabled' : ''}}>
                                                                                           <label class=" control-label2"
                                                                             ...
                                                                             <tr>
                                                                                    ...
                                                                                    <td>
                                                                                           <input type="checkbox"
                                                                                                  ...
                                                                                                  class="permission"
                                                                                                  {{in_array('rule.delete.list',$permissions)
                                                                                                  ? "checked" : "" }}
                                                                                                  {{$roles->id == 1 ?
                                                                                           'disabled' : ''}}>
                                                                                           <label class=" control-label2"
                                                                             ...
                                                                             <tr>
                                                                                    ...
                                                                                    <td>
                                                                                           <input type="checkbox"
                                                                                                  ...
                                                                                                  name="banners[]"
                                                                                                  class="permission"
                                                                                                  {{in_array('banners.list',$permissions)
                                                                                                  ? "checked" : "" }}
                                                                                                  {{$roles->id == 1 ?
                                                                                           'disabled' : ''}}>
                                                                                           <label class=" control-label2"
                                                                             ...
                                                                             <tr>
                                                                                    ...
                                                                                    <td>
                                                                                           <input type="checkbox"
                                                                                                  ...
                                                                                                  name="deleted-banner[]"
                                                                                                  class="permission"
                                                                                                  {{in_array('banner.delete.list',$permissions)
                                                                                                  ? "checked" : "" }}
                                                                                                  {{$roles->id == 1 ?
                                                                                           'disabled' : ''}}>
                                                                                           <label class="control-label2"
                                                                             ...
                                                                             <tr>
                                                                                    ...
                                                                                    <td>
                                                                                           <input type="checkbox"
                                                                                                  ...
                                                                                                  name="on-board[]"
                                                                                                  class="permission"
                                                                                                  {{in_array('onboard.list',$permissions)
                                                                                                  ? "checked" : "" }}
                                                                                                  {{$roles->id == 1 ?
                                                                                           'disabled' : ''}}>
                                                                                           <label class=" control-label2"
                                                                                           ...
                                                                                           <input type="checkbox"
                                                                                                  ...
                                                                                                  name="on-board[]"
                                                                                                  class="permission"
                                                                                                  {{in_array('onboard.edit',$permissions)
                                                                                                  ? "checked" : "" }}
                                                                                                  {{$roles->id == 1 ?
                                                                                           'disabled' : ''}}>
                                                                                           <label class=" control-label2"
                                                                             ...
                                                                             <tr>
                                                                                    ...
                                                                                    <td>
                                                                                           ...
                                                                                           <input type="checkbox"
                                                                                                  ...
                                                                                                  name="faq[]"
                                                                                                  class="permission"
                                                                                                  {{in_array('faq.create',$permissions)
                                                                                                  ? "checked" : "" }}
                                                                                                  {{$roles->id == 1 ?
                                                                                           'disabled' : ''}}>
                                                                                           <label class=" control-label2"
                                                                                           ...
                                                                                           <input type="checkbox"
                                                                                                  ...
                                                                                                  name="faq[]"
                                                                                                  class="permission"
                                                                                                  {{in_array('faq.delete',$permissions)
                                                                                                  ? "checked" : "" }}
                                                                                                  {{$roles->id == 1 ?
                                                                                           'disabled' : ''}}>
                                                                                           <label class=" control-label2"
                                                                             ...
                                                                             <tr>
                                                                                    ...
                                                                                    <td>
                                                                                           ...
                                                                                           <input type="checkbox"
                                                                                                  ...
                                                                                                  name="sos[]"
                                                                                                  class="permission"
                                                                                                  {{in_array('sos.delete',$permissions)
                                                                                                  ? "checked" : "" }}
                                                                                                  {{$roles->id == 1 ?
                                                                                           'disabled' : ''}}>
                                                                                           <label class=" control-label2"
                                                                             ...
                                                                             <tr>
                                                                                    ...
                                                                                    <td>
                                                                                           <input type="checkbox"
                                                                                                  ...
                                                                                                  name="coupon[]"
                                                                                                  class="permission"
                                                                                                  {{in_array('coupon.list',$permissions)
                                                                                                  ? "checked" : "" }}
                                                                                                  {{$roles->id == 1 ?
                                                                                           'disabled' : ''}}>
                                                                                           <label class=" control-label2"
                                                                                           ...
                                                                                           <input type="checkbox"
                                                                                                  ...
                                                                                                  name="coupon[]"
                                                                                                  class="permission"
                                                                                                  {{in_array('coupon.create',$permissions)
                                                                                                  ? "checked" : "" }}
                                                                                                  {{$roles->id == 1 ?
                                                                                           'disabled' : ''}}>
                                                                                           <label class=" control-label2"
                                                                                           ...
                                                                                           <input type="checkbox"
                                                                                                  ...
                                                                                                  name="coupon[]"
                                                                                                  class="permission"
                                                                                                  {{in_array('coupon.edit',$permissions)
                                                                                                  ? "checked" : "" }}
                                                                                                  {{$roles->id == 1 ?
                                                                                           'disabled' : ''}}>
                                                                                           <label class=" control-label2"
                                                                                           ...
                                                                                           <input type="checkbox"
                                                                                                  ...
                                                                                                  name="coupon[]"
                                                                                                  class="permission"
                                                                                                  {{in_array('coupon.delete',$permissions)
                                                                                                  ? "checked" : "" }}
                                                                                                  {{$roles->id == 1 ?
                                                                                           'disabled' : ''}}>
                                                                                           <label class=" control-label2"
                                                                             ...
                                                                             <tr>
                                                                                    ...
                                                                                    <td>
                                                                                           <input type="checkbox"
                                                                                                  ...
                                                                                                  name="deleted-coupon[]"
                                                                                                  class="permission"
                                                                                                  {{in_array('coupon.delete.list',$permissions)
                                                                                                  ? "checked" : "" }}
                                                                                                  {{$roles->id == 1 ?
                                                                                           'disabled' : ''}}>
                                                                                           <label class=" control-label2"
                                                                             ...
                                                                             <tr>
                                                                                    ...
                                                                                    <td>
                                                                                           <input type="checkbox"
                                                                                                  ...
                                                                                                  name="currency[]"
                                                                                                  class="permission"
                                                                                                  {{in_array('currency.list',$permissions)
                                                                                                  ? "checked" : "" }}
                                                                                                  {{$roles->id == 1 ?
                                                                                           'disabled' : ''}}>
                                                                                           <label class=" control-label2"
                                                                                           ...
                                                                                           <input type="checkbox"
                                                                                                  ...
                                                                                                  name="currency[]"
                                                                                                  class="permission"
                                                                                                  {{in_array('currency.create',$permissions)
                                                                                                  ? "checked" : "" }}
                                                                                                  {{$roles->id == 1 ?
                                                                                           'disabled' : ''}}>
                                                                                           <label class=" control-label2"
                                                                                           ...
                                                                                           <input type="checkbox"
                                                                                                  ...
                                                                                                  name="currency[]"
                                                                                                  class="permission"
                                                                                                  {{in_array('currency.edit',$permissions)
                                                                                                  ? "checked" : "" }}
                                                                                                  {{$roles->id == 1 ?
                                                                                           'disabled' : ''}}>
                                                                                           <label class=" control-label2"
                                                                                           ...
                                                                                           <input type="checkbox"
                                                                                                  ...
                                                                                                  name="currency[]"
                                                                                                  class="permission"
                                                                                                  {{in_array('currency.delete',$permissions)
                                                                                                  ? "checked" : "" }}
                                                                                                  {{$roles->id == 1 ?
                                                                                           'disabled' : ''}}>
                                                                                           <label class=" control-label2"
                                                                             ...
                                                                             <tr>
                                                                                    ...
                                                                                    <td>
                                                                                           <input type="checkbox"
                                                                                                  ...
                                                                                                  name="language[]"
                                                                                                  class="permission"
                                                                                                  {{in_array('language.list',$permissions)
                                                                                                  ? "checked" : "" }}
                                                                                                  {{$roles->id == 1 ?
                                                                                           'disabled' : ''}}>
                                                                                           <label class=" control-label2"
                                                                                           ...
                                                                                           <input type="checkbox"
                                                                                                  ...
                                                                                                  name="language[]"
                                                                                                  class="permission"
                                                                                                  {{in_array('language.delete',$permissions)
                                                                                                  ? "checked" : "" }}
                                                                                                  {{$roles->id == 1 ?
                                                                                           'disabled' : ''}}>
                                                                                           <label class=" control-label2"
                                                                             ...
                                                                             <tr>
                                                                                    ...
                                                                                    <td>
                                                                                           <input type="checkbox"
                                                                                                  ...
                                                                                                  class="permission"
                                                                                                  {{in_array('language.delete.list',$permissions)
                                                                                                  ? "checked" : "" }}
                                                                                                  {{$roles->id == 1 ?
                                                                                           'disabled' : ''}}>
                                                                                           <label class=" control-label2"
                                                                             ...
                                                                             <tr>
                                                                                    ...
                                                                                    <td>
                                                                                           <input type="checkbox"
                                                                                                  ...
                                                                                                  name="payout-request[]"
                                                                                                  class="permission"
                                                                                                  {{in_array('payout-request',$permissions)
                                                                                                  ? "checked" : "" }}
                                                                                                  {{$roles->id == 1 ?
                                                                                           'disabled' : ''}}>
                                                                                           <label class=" control-label2"
                                                                             ...
                                                                             <tr>
                                                                                    ...
                                                                                    <td>
                                                                                           <input type="checkbox"
                                                                                                  ...
                                                                                                  class="permission"
                                                                                                  {{in_array('driver.wallet.list',$permissions)
                                                                                                  ? "checked" : "" }}
                                                                                                  {{$roles->id == 1 ?
                                                                                           'disabled' : ''}}>
                                                                                           <label class=" control-label2"
                                                                             ...
                                                                             <tr>
                                                                                    ...
                                                                                    <td>
                                                                                           <input type="checkbox"
                                                                                                  ...
                                                                                                  class="permission"
                                                                                                  {{in_array('user.wallet.list',$permissions)
                                                                                                  ? "checked" : "" }}
                                                                                                  {{$roles->id == 1 ?
                                                                                           'disabled' : ''}}>
                                                                                           <label class=" control-label2"
                                                                             ...
                                                                             <tr>
                                                                                    ...
                                                                                    <td>
                                                                                           <input type="checkbox"
                                                                                                  ...
                                                                                                  name="global-setting[]"
                                                                                                  class="permission"
                                                                                                  {{in_array('global-setting',$permissions)
                                                                                                  ? "checked" : "" }}
                                                                                                  {{$roles->id == 1 ?
                                                                                           'disabled' : ''}}>
                                                                                           <label class=" control-label2"
                                                                             ...
                                                                             <tr>
                                                                                    ...
                                                                                    <td>
                                                                                           <input type="checkbox"
                                                                                                  ...
                                                                                                  class="permission"
                                                                                                  {{in_array('admin-commision',$permissions)
                                                                                                  ? "checked" : "" }}
                                                                                                  {{$roles->id == 1 ?
                                                                                           'disabled' : ''}}>
                                                                                           <label class=" control-label2"
                                                                             ...
                                                                             <tr>
                                                                                    ...
                                                                                    <td>
                                                                                           <input type="checkbox"
                                                                                                  ...
                                                                                                  class="permission"
                                                                                                  {{in_array('home-page',$permissions)
                                                                                                  ? "checked" : "" }}
                                                                                                  {{$roles->id == 1 ?
                                                                                           'disabled' : ''}}>
                                                                                           <label class=" control-label2"
                                                                             ...
                                                                             <tr>
                                                                                    ...
                                                                                    <td>
                                                                                           <input type="checkbox"
                                                                                                  ...
                                                                                                  name="zone[]"
                                                                                                  class="permission"
                                                                                                  {{in_array('zone.list',$permissions)
                                                                                                  ? "checked" : "" }}
                                                                                                  {{$roles->id == 1 ?
                                                                                           'disabled' : ''}}>
                                                                                           <label class=" control-label2"
                                                                                           ...
                                                                                           <input type="checkbox"
                                                                                                  ...
                                                                                                  name="zone[]"
                                                                                                  class="permission"
                                                                                                  {{in_array('zone.create',$permissions)
                                                                                                  ? "checked" : "" }}
                                                                                                  {{$roles->id == 1 ?
                                                                                           'disabled' : ''}}>
                                                                                           <label class=" control-label2"
                                                                                           ...
                                                                                           <input type="checkbox"
                                                                                                  ...
                                                                                                  name="zone[]"
                                                                                                  class="permission"
                                                                                                  {{in_array('zone.edit',$permissions)
                                                                                                  ? "checked" : "" }}
                                                                                                  {{$roles->id == 1 ?
                                                                                           'disabled' : ''}}>
                                                                                           <label class=" control-label2"
                                                                                           ...
                                                                                           <input type="checkbox"
                                                                                                  ...
                                                                                                  name="zone[]"
                                                                                                  class="permission"
                                                                                                  {{in_array('zone.delete',$permissions)
                                                                                                  ? "checked" : "" }}
                                                                                                  {{$roles->id == 1 ?
                                                                                           'disabled' : ''}}>
                                                                                           <label class=" control-label2"
