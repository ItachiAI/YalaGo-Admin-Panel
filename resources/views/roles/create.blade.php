                                        ...
                                        <table class="table table-striped">
                                            ...
                                            <tbody>
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        ...
                                                        <input type="checkbox" id="intercity-delete"
                                                            value="intercity.service.delete" name="intercity_service[]"
                                                            class="permission">
                                                        <label class=" control-label2"
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        <input type="checkbox" id="moving-list" value="moving.list"
                                                            name="moving[]" class="permission">
                                                        <label class=" control-label2"
                                                            for="moving-list">{{trans('lang.list')}}</label>

                                                        <input type="checkbox" id="moving-create"
                                                            value="moving.create" name="moving[]" class="permission">
                                                        <label class=" control-label2"
                                                            for="moving-create">{{trans('lang.create')}}</label>

                                                        <input type="checkbox" id="moving-edit" value="moving.edit"
                                                            name="moving[]" class="permission">
                                                        <label class=" control-label2"
                                                            for="moving-edit">{{trans('lang.edit')}}</label>

                                                        <input type="checkbox" id="moving-delete"
                                                            value="moving.delete" name="moving[]" class="permission">
                                                        <label class=" control-label2"
